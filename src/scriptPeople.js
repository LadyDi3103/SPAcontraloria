  ...
  async function handleInteraction(interactionType) {
    if (ObraId !== 0){
        ...
        if (interactionType === 'like') {
          ...
          } else if (obrasReacciones[ObraId].likePressed && !obrasReacciones[ObraId].dislikePressed){
            obrasReacciones[ObraId].likePressed = false;
            likeCount = await updateCounter('like', likeCount - 1);
          }
          document.getElementById('likeCount').innerText = likeCount;
          ...
          } else if (obrasReacciones[ObraId].dislikePressed && !obrasReacciones[ObraId].likePressed) {
